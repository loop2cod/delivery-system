// Jest configuration for Business PWA
module.exports = {
  ...
  // Environment variables for business testing
  ...
  // Additional setup for business-specific features
  setupFiles: [
    '<rootDir>/../../tests/setup/__mocks__/businessMocks.js'
  ]
};