                  ...
                  <div className="flex h-16 shrink-0 items-center">
                    <div className="flex items-center space-x-3">
                      <div className="w-8 h-8 bg-accent rounded-xl flex items-center justify-center">
                        <BuildingOfficeSolidIcon className="w-5 h-5 text-white" />
                      </div>
                      <span className="text-xl font-bold text-white">UAE Business</span>
                    </div>
                  </div>
          ...
          <div className="flex h-16 shrink-0 items-center">
            <div className="flex items-center space-x-3">
              <div className="w-10 h-10 bg-accent rounded-xl flex items-center justify-center">
                <BuildingOfficeSolidIcon className="w-6 h-6 text-white" />
              </div>
              <div>
                <span className="text-xl font-bold text-white">UAE Business</span>
                <p className="text-xs text-primary-100">Delivery Portal</p>
              </div>
            </div>
          </div>
                ...
                <div className="bg-primary-800 rounded-xl p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-sm font-medium text-white truncate">TechCorp Solutions</p>
                      <p className="text-xs text-primary-100 truncate">Technology Company</p>
                    </div>
                  </div>
                  <div className="mt-3 pt-3 border-t border-primary-700">
                    <p className="text-xs text-primary-100">
                      Active Plan: <span className="text-white font-medium">Business Pro</span>
                    </p>
                  </div>
                </div>
              </li>
