...
const notifications = [
  {
    ...
    message: 'Package #PKG-2024-001 delivered successfully',
    time: '5 min ago',
    unread: true,
    type: 'success',
  },
  ...
  },
  {
    ...
    message: 'Package #PKG-2024-002 delayed due to traffic',
    time: '2 hours ago',
    unread: false,
    type: 'warning',
  },
      ...
      <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <form className="relative flex flex-1" action="#" method="GET">
          ...
          <input
            ...
            placeholder="Search deliveries, invoices, team members..."
            type="search"
            name="search"
          />
        </form>
        ...
        <div className="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <button
            type="button"
            className="hidden sm:flex items-center gap-x-2 rounded-md bg-primary px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-primary/90 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
